...
import { _ as E, u as S } from "./official-CqoFBQPj.js";
import { _ as D } from "./FooterBar.vue_vue_type_script_setup_true_lang-MHvwC9SW.js";
import { I as F } from "./index-fq4iQGBU.js";
import "./tres-aceJk2L8.js";
import "./official-website-Cnxq3Yc9.js";
import "./providerSetting-Cpco8HXt.js";
import "./LeftOutlined-BRZ2HLK1.js";
function R(i) {
  return null == i
    ? []
    : (function (t, i) {
...
const W = "/assets/coin-DMaGRSCL.png",
  ...
  te = J(() =>
    c(
      ...
      [
        ...
        c("a", { href: "https://app.uniswap.org/swap?inputCurrency=ETH&outputCurrency=0xcomingsoon", targt: "_blank" }, [
          c(
            "button",
            {
              "bg-primary": "",
              ...
              c("div", V, [
                c("div", $, [
                  c("div", Y, [
                    ...
                    Q,
                    d(
                      " Season Two: Join the Waiting List and Earn More Badge! "
                    ),
                    c(
                      "img",
                      {
  ...
  ue = { "bg-primary": "", "size-13": "", flex: "~ center", "rounded-1": "" },
  xe = { "font-bold": "", "break-words": "", "text-2xl": "" },
  ye = x({
    __name: "BackedByV1",
    setup(e) {
      const t = y([
  ...
  je = "/resource/img/chainopera/home/co-logo-arrow.svg",
  Le = "/resource/img/chainopera/home/co-logo-app-developer.svg",
  ...
  Fe = c(
    ...
    [
      ...
      c("figure", { flex: "~ col center gap-2", "lt-lg": "rotate-90deg" }, [
        ...
        c("img", { src: je, "rotate-180deg": "", "lt-lg": "rotate-0" }),
      ]),
    ],
    -1
  ),
      ...
      c(
        ...
        [
          ...
          c(
            ...
            [
              c("figure", { flex: "~ col center gap-4" }, [
                c("img", { class: "size-16 lt-lg-size-12", src: Le }),
                c(
                  "figcaption",
      ...
      return (
        _(async () => {
          ...
          window.addEventListener("resize", () => {
            ...
            const t = l / 2,
              i = s / 2;
            (c = 0.15 * Math.min(t, i)), (p = 0.618 * c), u(t, i, c);
          }),
      ...
      return (e, u) => {
        ...
        return s(
          ...
          r("section", Je, [
            c("div", Ve, [
              c("div", $e, [
                s((o(), r("div", Ye, [d(" ChainOpera AI ")])), [[x]]),
                s((o(), r("span", Xe, [d(w(t), 1)])), [[x]]),
                s((o(), r("span", Qe, [d(w(i), 1)])), [[x]]),
                s(
                  (o(),
                  r("div", Ze, [
                    s(
                      ...
                      C(
                        ...
                        {
                          to: {
                            name: ("routerNames" in e ? e.routerNames : p(L))
                              .MODEL_MKT_HOME,
                          },
                          hover: "z-2",
                          initial: { opacity: 0, x: -50 },
  ...
  jt = c(
    ...
    ' The ChainOpera Al Mobile App features an Al Terminal with a "Type to Earn" system that benefits humanity by allowing users to contribute their data for LLM and GenAl model training. ',
    -1
  ),
  Lt = {
    initial: { opacity: 0, x: -20 },
  ...
  Tt = c(
    ...
    [
      d(" The "),
      c("b", null, "Al Terminal"),
      d(
        " also functions as a powerful Al agent that simplifies cryptocurrency management by providing actionable insighis about AI coins on the ChainOpera platform and other meme coins. "
      ),
    ],
    -1
  ),
  Et = c(
    ...
    [
      ...
      c("b", null, "Al Terminal"),
      d(
        " is your personal companion that represents you and completes various tasks in your lfe and work. Eventualy, the AI terminal will evolve into your personal Al operating system. "
      ),
    ],
    -1
  ),
  ...
  Nt = c(
    ...
    [c("span", null, "ChainOpera AI Agent Society")],
    -1
  ),
  Kt = c(
    "p",
    ...
    [
      d(" Going beyond a Hub for diverse Al Agents and Apps. "),
      c("br"),
      d(
        " lt's the virtual world where Al agents live, chat, socialize, and work for Human -like Linkedin but designed for Al Agents. "
      ),
    ],
    -1
  ),
  ...
  Yt = c(
    ...
    " Federated Al OS is the world's leading platform for creating, deploying, and managing Al agents. lt seamlessly integrates Launchpad CoAI SDK, AI Agent framework, and AI Agent Template Marketplace to streamline the AI agent creation process. ",
    -1
  ),
  Xt = c(
    "h2",
  ...
  ti = c(
    "p",
    { class: "mb-12 leading-5 !font-normal" },
    " The Launchpad and AI Agent Template Marketplace enable anyone to create AI agents effortlessly. ",
    -1
  ),
  ii = {
    initial: { opacity: 0, y: 40 },
  ...
  ni = c(
    "p",
    { class: "mb-12 leading-5 !font-normal" },
    ' DeAl Phone wil integrate our products as default applications, evolving into an "appless" Al OS for agents. it features core system and blockchain capabilities for managing DiD accounts, token wallets, custom tokenomics, and rewards for contributing data (including chats, images, and more). ',
    -1
  ),
  li = {
    initial: { opacity: 0, y: 40 },
  ...
  Bi = [c("span", null, "Phase 1: ChainOpera AI Chain TestNet", -1)],
  Ni = {
    initial: { opacity: 0, y: 20 },
    "visible-once": {
      opacity: 1,
  ...
  Hi = [c("span", null, "Phase 2: ChainOpera AI Chain MainNet", -1)],
  Wi = {
    initial: { opacity: 0, y: 20 },
    "visible-once": {
      opacity: 1,
  ...
  Ji = [
    c("span", null, "• Token & DApp data migration", -1),
        ...
        (e, i) => (
          ...
          r("div", Yi, [
            c("div", Xi, [
              ...
              v(He),
              c("div", Qi, [v(ne), v(ye)]),
              v(xt, { list: p(t).getPressList }, null, 8, ["list"]),
